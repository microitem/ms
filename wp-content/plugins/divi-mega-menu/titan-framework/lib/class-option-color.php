...
class TitanFrameworkOptionColor extends TitanFrameworkOption {
	...
	public function enqueueColorPickerScript() {
		// get the current admin page settings page we are on
		$screen = get_current_screen();

		// if screen id has gridbuilder, then do not enqueue the color picker script
		if ( strpos( $screen->id, 'gridbuilder' ) !== false ) {
			return;
		}
